...
#!/bin/bash
    ...
    replicates="1-50";
    #outputDir=pdf_Lmem_Dkp15_Drl15/tavg_on_c4_7_c5_5_c6_4_250a.dat;
...
reps=(250 500 1000 1500 2000);
	...
	for j in $js; do
		...
		outputDir=pdf_Lmem_Dkp15_Drl15/counts_tavg_on_c4_7_c5_5_c6_4_${maxReplicates}a.dat;
		mkdir ../matlab/${outputDir};
		   ...
		   python-submit calc_test_onState_reps.py ../matlab/${outputDir} ../${dataDir}/${filename} ${maxReplicates} ${species} ${onThreshold} ${i} ${j} ${k} ../${logsDir}/calc_pdf_${filename}.${maxReplicates}.${species}.on.log batch rsharm28 22:00:00;	      	   
