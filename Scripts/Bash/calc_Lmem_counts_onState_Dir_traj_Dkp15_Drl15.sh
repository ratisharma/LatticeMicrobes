...
#!/bin/bash
    ...
    #replicates="1-50";
    outputDir=pdf_Lmem_Dkp15_Drl15/gradient/Dirs_traj_on_c4_7_c5_5_c6_4.dat;
    dataDir=data_Dkp15_Drl15_memThick2/gradient;
    logsDir=logs_Dkp15_Drl15_memThick2/gradient;
    onThresholds=(44 10 7);
	Dk=5.0e-12;
...
filename=cell_rdme_Lmem_gradSteep_t500_${p}_c1b_${c1b}_c2b_${c2b}_c3b_${c3b}_c0a_${c0a}_c4_${c4}_c5_${c5}_c6_${c6}_Dk_${Dk}_Dkp_${Dkp}_Dr_${Dr}_Drl_${Drl}.lm;
						...
						if [ ! -e "../matlab/${outputDir}/${matfilename}" ]; then
	    					...
	    					python-submit calc_counts_onState_traj_Dir_replicates.py ../matlab/${outputDir} ../${dataDir}/${filename} ${species} ${onThreshold} ${i} ${j} ${p} ${k} ../${logsDir}/calc_counts_${filename}.${species}.on.log batch rsharm28 1:00:00;  	   
						else
