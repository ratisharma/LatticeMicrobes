...
#!/bin/bash
    ...
    #replicates="1-50";
    outputDir=pdf_Lmem_Dkp15_Drl15/gradient/Dirs_delt_on_c4_7_c5_5_c6_4.dat;
    dataDir=data_Dkp15_Drl15_memThick2/gradient;
    logsDir=logs_Dkp15_Drl15_memThick2/gradient;
    #outputDir=feedback_kp/pdf_Lmem_Dkp15_Drl15/gradient/Dirs_delt_on_c7_4.0e-6.dat;
    #dataDir=feedback_kp/data_Dkp15_Drl15_memThick2/gradient/c7_4.0e-6;
    #logsDir=feedback_kp/logs_Dkp15_Drl15_memThick2/gradient/c7_4.0e-6;
    onThresholds=(44 10 10);
    #finalTime=10
	Dk=5.0e-12;
	...
	finalTimes=(50 100 150 200 250 300 350 400 450 500);
    is=`seq -f "%g" 4 4`;
    js=`seq -f "%g" 4 4`;
    ks=`seq -f "%g" 2 2`;
    ls=`seq -f "%g" 6 6`;
...
###filename=cell_rdme_Lmem_gradSteep_t500_${p}_c1b_${c1b}_c2b_${c2b}_c3b_${c3b}_c0a_${c0a}_c4_${c4}_c5_${c5}_c6_${c6}_c7_${c7}_Dk_${Dk}_Dkp_${Dkp}_Dr_${Dr}_Drl_${Drl}.lm;	    					
						...
						#rm -f ../${logsDir}/calc_counts_${filename}.${species}.${finalTime}.on.log;
						if [ ! -e "../matlab/${outputDir}/${matfilename}" ]; then
	    					...
	    					python-submit calc_counts_onState_Dir_delt.py ../matlab/${outputDir} ../${dataDir}/${filename} ${species} ${onThreshold} ${finalTime} ${i} ${j} ${p} ${k} ${r} ../${logsDir}/calc_counts_${filename}.${species}.${finalTime}.on.log batch rsharm28 4:00:00;  	   
						else
