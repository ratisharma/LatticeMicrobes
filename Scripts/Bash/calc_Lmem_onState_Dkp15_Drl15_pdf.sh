...
#!/bin/bash
    ...
    replicates="1-50";
    outputDir=pdf_Lmem_Dkp15_Drl15/tavg_on_c4_7_c5_5_c6_4_all.dat;
...
#c6s=(1.0e-3);
	...
	for j in $js; do
		...
		mkdir ../matlab/${outputDir};
		   ...
		   python-submit calc_test_onState.py ../matlab/${outputDir} ../${dataDir}/${filename} ${species} ${onThreshold} ${i} ${j} ${k} ../${logsDir}/calc_pdf_${filename}.${species}.on.log batch rsharm28 22:00:00;	      	   
