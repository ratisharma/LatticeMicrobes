...
#!/bin/bash
    ...
    #replicates="1-50";
    outputDir=feedback_kp/pdf_Lmem_Dkp15_Drl15/min_ligand/Dirs_tavg_on_c7_4.0e-6.dat;
    dataDir=feedback_kp/data_Dkp15_Drl15_memThick2/min_ligand/c7_4.0e-6;
    logsDir=feedback_kp/logs_Dkp15_Drl15_memThick2/min_ligand/c7_4.0e-6;
...
filename=cell_rdme_Lmem_gradSteep_t500_${p}_c1b_${c1b}_c2b_${c2b}_c3b_${c3b}_c0a_${c0a}_c4_${c4}_c5_${c5}_c6_${c6}_c7_${c7}_Dk_${Dk}_Dkp_${Dkp}_Dr_${Dr}_Drl_${Drl}.lm;
						...
						if [ ! -e "../matlab/${outputDir}/${matfilename}" ]; then
	    					...
	    					python-submit calc_counts_onState_Dir.py ../matlab/${outputDir} ../${dataDir}/${filename} ${species} ${onThreshold} ${i} ${j} ${p} ${k} ../${logsDir}/calc_counts_${filename}.${species}.on.log batch rsharm28 4:00:00;  	   
						else
