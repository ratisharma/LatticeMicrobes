...
%         species=sp(i);
%         if (i==3)
%             inputFilename=sprintf('../pdf/pdf_c6_4_memThick2/Dkp_5e-15.dat/00005.00002.0000%d.mat',species);
%         else
%             inputFilename=sprintf('../pdf/pdf_c6_4_memThick2/Dkp_5e-15.dat/00005.00002.0000%d.00001.mat',species);
%         end
        inputFilename=sprintf('../pdf/pdf_c6_4_memThick2/Dkp_5e-15.dat/00005.00002.0000%d.0000%d.mat',species,rep);
load(inputFilename);
...
% title(['species=,',num2str(species), ',rep= ',num2str(rep)])
% hold;
% scatter(phi,mean2)
%  contourf(Zinterp)
figure (2)
