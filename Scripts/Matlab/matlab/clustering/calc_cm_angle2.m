...
%   filename=sprintf('../../feedback_kp/data_Dkp13_Drl13_memThick2/min_ligand/cell_rdme_Lmem_gradSteep_t500_%d_c1b_2.0e-5_c2b_6.0e-5_c3b_3.0e-3_c0a_4.0e-3_c4_7.5e-3_c5_6.0e-3_c6_4.5e-5_c7_4.5e-06_Dk_5.0e-12_Dkp_5.0e-13_Dr_5.0e-12_Drl_5.0e-13.lm',d);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%    D=Dkp14
%   filename=sprintf('../../data_Dkp14_Drl14_memThick2/gradient/cell_rdme_Lmem_gradSteep_t500_%d_c1b_1.0e-5_c2b_2.0e-5_c3b_2.0e-3_c0a_4.0e-3_c4_7.5e-3_c5_7.0e-3_c6_4.5e-5_Dk_5.0e-12_Dkp_5.0e-14_Dr_5.0e-12_Drl_5.0e-14.lm',d);
% filename=sprintf('../../feedback_kp/data_Dkp14_Drl14_memThick2/min_ligand/cell_rdme_Lmem_gradSteep_t500_%d_c1b_1.0e-5_c2b_2.0e-5_c3b_2.0e-3_c0a_4.0e-3_c4_7.5e-3_c5_7.0e-3_c6_4.5e-5_c7_4.5e-06_Dk_5.0e-12_Dkp_5.0e-14_Dr_5.0e-12_Drl_5.0e-14.lm',d);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %   %%%%    D=1.0Dkp14
  filename=sprintf('../../data_1.0Dkp14_Drl14_memThick2/min_ligand/cell_rdme_Lmem_gradSteep_t500_%d_c1b_0.6e-5_c2b_1.2e-5_c3b_1.5e-3_c0a_4.0e-3_c4_7.1e-3_c5_6.0e-3_c6_4.3e-5_Dk_5.0e-12_Dkp_1.0e-14_Dr_5.0e-12_Drl_1.0e-14.lm',d);
...
% outputFilename1=sprintf('analysisData/cm_1.0Dk14/min_ligand/min_ligand_%d.mat',d);
