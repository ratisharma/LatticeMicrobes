...
% filename=sprintf('../../data/data_Dkp15_Drl15_memThick2/gradient/cell_rdme_Lmem_gradSteep_t500_20_c1b_0.5e-5_c2b_1.0e-5_c3b_1.0e-3_c0a_4.0e-3_c4_7.0e-3_c5_5.0e-3_c6_4.0e-5_Dk_5.0e-12_Dkp_5.0e-15_Dr_5.0e-12_Drl_5.0e-15.lm');
cutoffDistance=25;
% msd2=zeros(20,200);
for replicate=1:10
    replicate
...
% outputFilename=sprintf('analysisData/msd_cm/feedback_gradient_msd_cm_%d.mat',d);
% save(outputFilename,'msd2','cm3');
clear msd2 cm3
end
