...
%         matfile1=sprintf('analysisData/feedback_kp/pdf_min_ligand.mat');
%         matfile2=sprintf('analysisData/feedback_kp/pdf_gradient.mat');
    elseif (file==4)
...
% subplot(1,2,2)
% figure
% scatter(theta,z1,10,angle,'filled'),colorbar
% figure
% scatter3(x1,y1,z1,10,angle,'filled'),colorbar
...
legend('D=5.0e-14','D=1.0e-14', 'D=0.5e-14','Ligand')
xlabel('omega');
ylabel('density')
axis([0 3.2 0.84 1.25])
ax = gca;
ax.XTick = [0 pi/2 pi];
