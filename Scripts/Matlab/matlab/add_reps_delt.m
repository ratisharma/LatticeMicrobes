...
%     inputFilename=sprintf('../pdf/pdf_Lmem_Dkp15_Drl15/min_ligand/Dirs_delt_on_c4_7_c5_5_c6_4.dat/00005.00005.%05d.00003.%05d.mat',d,delt);
    inputFilename=sprintf('../pdf/feedback_kp/pdf_Lmem_Dkp15_Drl15/gradient/Dirs_delt_on_c7_4.0e-6.dat/00005.00005.%05d.00003.%05d.mat',d,delt);
...
% end
load(inputFilename);
fprintf('Processing filename %d %d\n',d,delt);
...
outputFilename=sprintf('analysisData/pdf_delt/pdf_feedback_gradient_delt_%d.mat',delt);
